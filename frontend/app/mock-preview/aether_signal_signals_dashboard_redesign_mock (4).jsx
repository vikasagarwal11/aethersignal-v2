      ...
      <header className="h-16 border-b border-gray-800 bg-[#10141C]/95 backdrop-blur flex items-center justify-between px-4 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-gray-400">AI-powered pharmacovigilance</div>
          </div>
    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70">
      <div className="w-full max-w-2xl rounded-2xl border border-[#262A33] bg-[#05060A] px-5 py-4 shadow-2xl">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div>
            ...
            <div className="text-[10px] text-gray-400 mt-0.5">
              Select one or more files. ZIP archives are treated as a single upload;
              individual files will be tracked once the archive is unpacked
              server-side.
            </div>
          </div>
          <button
                ...
                items.map((item) => (
                  <tr key={item.id} className="border-t border-[#262A33]">
                    <td className="px-3 py-2 align-top">
                      ...
                      {item.isZip && (
                        <div className="text-[10px] text-gray-400 mt-0.5">
                          ZIP archive – overall progress shown here; inner files
                          will appear after server-side unpacking.
                        </div>
                      )}
                    </td>
        ...
        <div className="mt-3 flex items-center justify-between text-[10px] text-gray-400">
          <div>
            <div>
              CFR-style timestamps and audit trail will be attached to each file
              on ingestion.
            </div>
