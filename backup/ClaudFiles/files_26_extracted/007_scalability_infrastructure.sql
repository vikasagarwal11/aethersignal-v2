-- Database Migration: Scalability & Performance Optimization
-- Version: 007_scalability_infrastructure
-- Date: 2024-12-08
...
CREATE INDEX IF NOT EXISTS idx_age_serious 
    ON pv_cases(patient_age, serious) 
...
SELECT 
    ...
    AVG(ror) as avg_ror,
    AVG(ic) as avg_ic,
    MAX(is_statistical_signal) as has_signal,
...
-- Verification query
SELECT 
    'Migration 007_scalability_infrastructure completed' as status,
